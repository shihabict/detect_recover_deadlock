...
if has_deadlock:
    ...
    rag = builder.build_rag()
    visualizer = RAGVisualizer(rag)
    visualizer.draw(filename='output_images/rag_before_suspension_case4')
    ...
    rag = builder.build_rag()
    visualizer = RAGVisualizer(rag)
    visualizer.draw(filename='output_images/rag_after_suspension_case4')
    ...
    rag = builder.build_rag()
    visualizer.draw(filename='output_images/rag_final_restored_case4')
else:
